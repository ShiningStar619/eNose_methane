...
2. **Search the vault for counter-evidence.** Use
   `C:/Users/PKSpu/AppData/Roaming/uv/tools/hyperresearch/Scripts/hyperresearch.exe search "<keyword>" --tag <vault_tag> -j` to find interim
   ...
   (`C:/Users/PKSpu/AppData/Roaming/uv/tools/hyperresearch/Scripts/hyperresearch.exe note show <id> -j`).
